...
public class AtualizaActivity extends AppCompatActivity {
    ...
    private EditText etEnderecoAtualiza;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNomeAtualiza = findViewById(R.id.txtNome);
        etEnderecoAtualiza = findViewById(R.id.txtEndereco);
        ...
        etEnderecoAtualiza.setText(cursor.getString(cursor.getColumnIndexOrThrow("endereco")));

    }

    public void atualiza (View view){
        ControlaBanco crud = new ControlaBanco(getBaseContext());
        crud.alteraDado(Integer.parseInt(codigo), etNomeAtualiza.getText().toString(), etEnderecoAtualiza.getText().toString());
